...
public class AstarPath : VersionedMonoBehaviour {
	...
	/// safe wrappers (like <see>
	///     <cref>AddWorkItem)</cref>
	/// </see>
	/// multithreading can cause strange errors and pathfinding stopping to work if you are not careful.
	...
	/// 
	/// This only applies to graph updates requested using the <see>
	///     <cref>UpdateGraphs</cref>
	/// </see>
	/// method. Not those requested
	/// using <see cref="RegisterSafeUpdate"/> or <see>
	///     <cref>AddWorkItem</cref>
	/// </see>
	/// .
	/// 
	...
	public bool LimitGraphUpdates { get => batchGraphUpdates;
	...
	public float MaxGraphUpdateFreq { get => graphUpdateBatchingInterval;
	...
	/// Note: This does *not* includes other types of work items such as navmesh cutting or anything added by <see cref="RegisterSafeUpdate"/> or <see>
	///     <cref>AddWorkItem</cref>
	/// </see>
	/// .
	/// </summary>
	...
	/// Such as normal graph updates, navmesh cutting and anything added by <see cref="RegisterSafeUpdate"/> or <see>
	///     <cref>AddWorkItem</cref>
	/// </see>
	/// .
	/// </summary>
	...
	private static OnPathDelegate _onPathPreSearch;
	...
	private static OnPathDelegate _onPathPostSearch;

	/// <summary>Called before starting the scanning</summary>
	private static OnScanDelegate _onPreScan;
	...
	/// </summary>
	private static System.Action _on65KOverflow;
	...
	/// See: <see>
	///     <cref>Pathfinding.NavmeshCut</cref>
	/// </see>
	/// </summary>
	...
	private AstarPath () {
		...
		graphUpdates.OnGraphsUpdated += () => {
			if (_onGraphsUpdated != null) {
				_onGraphsUpdated(this);
			}
		};
	}
	...
	public static string[] FindTagNames () {
		FindAstarPath();
		return active != null? active.GetTagNames () : new[] { "There is no AstarPath component in the scene" };
	}

	/// <summary>Returns the next free path ID</summary>
	internal ushort GetNextPathID () {
		if (nextFreePathID != 0) return nextFreePathID++;
		nextFreePathID++;

		if (_on65KOverflow == null) return nextFreePathID++;
		var tmp = _on65KOverflow;
		_on65KOverflow = null;
		tmp();
	...
	void OnDestroy () {
		...
		// Clear all callbacks
		_onAwakeSettings         = null;
		_onGraphPreScan          = null;
		_onGraphPostScan         = null;
		_onPathPreSearch         = null;
		_onPathPostSearch        = null;
		_onPreScan               = null;
		_onPostScan              = null;
		_onLatePostScan          = null;
		_on65KOverflow           = null;
		_onGraphsUpdated         = null;
	...
	public IEnumerable<Progress> ScanAsync (NavGraph[] graphsToScan = null) {
		...
		if (_onLatePostScan != null) {
			_onLatePostScan(this);
		}
	...
	IEnumerable<Progress> ScanGraph (NavGraph graph) {
		if (_onGraphPreScan != null) {
			yield return new Progress(0, "Pre processing");
			_onGraphPreScan(graph);
		}
