...
{
    public class FriendlyUnit : Unit, IPointerDownHandler, IPointerUpHandler
    {
        ...
        {
            base.Attack();
            DataManager.SumDamage(_towerTypeEnum, damage);
        }
        ...
        public async UniTask Move(Vector3 pos)
        {
            ...
            navMeshAgent.stoppingDistance = atkRange;
            _moveInput = false;
            anim.SetBool(IsWalk, false);
        }

        public void SpawnInit(UnitTower unitTower, TowerType towerTypeEnum, Vector3 pos)
        {
            _originPos = pos;
