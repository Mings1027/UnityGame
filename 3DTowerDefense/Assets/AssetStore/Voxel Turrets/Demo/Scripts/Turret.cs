namespace MoenenGames.Turrets
{
    ...
    {
        [SerializeField] [Range(0f, 180f)] private float Limit = 180f;
        ...
        protected virtual void Update()
        {
            ...
            // Clamp
            var localY = Mathf.Repeat(transform.localRotation.eulerAngles.y + 180f, 360f) - 180f;
