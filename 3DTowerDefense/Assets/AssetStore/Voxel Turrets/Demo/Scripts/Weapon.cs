namespace MoenenGames.Turrets
{
    ...
    public class Weapon : MonoBehaviour
    {
        ...
        private Transform Model => model ? model : transform;

        private float PrevAttackTime { get; set; } = float.MinValue;

        private bool ReadyToShoot
        {
            get
            {
                var len = ConflictWeapons.Length;
        ...
        [Header("Game")] [SerializeField] private float AttackFrequency = 0.4f;
        [SerializeField] private float BulletSpeed = 60f;
        [SerializeField] private float BulletSize = 0.3f;
        [SerializeField] private float RandomTimeGap = 0.05f;
        ...
        [SerializeField] private Vector3 CurveRandom = Vector3.zero;
        [SerializeField] private KeyCode AttackKey = KeyCode.Mouse0;

        [Header("Component")] [SerializeField] private ParticleSystem[] Particles = new ParticleSystem[0];
        [SerializeField] private Weapon[] ConflictWeapons;
        [SerializeField] private Transform Bullet;
        [SerializeField] private LerpLight TheLight;
        [SerializeField] private Transform model;
        [SerializeField] private Transform bulletSpawnPivot;
        ...
        void Reset()
        {
            ...
            var rws = new List<Weapon>(transform.parent.GetComponentsInChildren<Weapon>(true));
